...
(function() {
  var cardToCardNum, config, createCanvas, drawBettingChips, drawBoard, drawHands, drawNameBox, drawSpectatorData, drawcard, dummyTableInfo, getPlayersXYByNum, imageName, images, loadingMovie, movieCounter, prepareForGames, setColorAndFont;
  ...
  imageName = ['Tranp.png', 'bg1.png', 'chip1.png', 'chip2.png', 'chip5.png', 'chip10.png', 'chip50.png', 'chip100.png', 'chip500.png', 'chip1000.png'];
  ...
  drawSpectatorData = function(data) {
    var player, playerId, playersXY, _ref, _results;
    ...
    for (playerId in _ref) {
      ...
      drawNameBox(player, playersXY[playerId].nameX, playersXY[playerId].nameY);
  ...
  drawNameBox = function(player, nameX, nameY) {
    console.log(player);
    ...
    if (player.lastAction) {
      return config.ctx.fillText(player.lastAction, nameX + 1, nameY + (config.nameFontSize + 1) * 3);
    }
  };
  ...
  drawBoard = function(board) {
    var boardCard, cardNum, drawX, drawY, _i, _len, _results;
