...
(function() {
  var cardToCardNum, config, createCanvas, drawBettingChips, drawBoard, drawEndResult, drawHands, drawNameBox, drawSpectatorData, drawcard, dummyTableInfo, getPlayersXYByNum, imageName, images, loadingMovie, movieCounter, prepareForGames, setColorAndFont;
  ...
  drawSpectatorData = function(data) {
    var player, playerId, playersXY, _ref;
