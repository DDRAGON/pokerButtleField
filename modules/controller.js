...
(function() {
  var Config, action, addHasActionToActives, blindUp, createDeck, dealPlayersHands, dealPreFlop, dealRiver, dealTurn, findNextActionPlayerSeat, gameStart, getActionPlayer, getInfo, getNextCommand, getState, getTableInfo, getTableInfoForWebSocketter, goToNextHand, goToNextPhase, goToNextTurn, intervalTime, join, level, playersCount, shuffleArray, shufflePlayers, state, structure, tables;
  ...
  action = function(data, callback) {
    var actionPlayerSeat, amount, key, nextCommand, player, playerSeat, tableId, winPlayerSeat, _ref;
