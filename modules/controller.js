...
(function() {
  var Config, blindUp, createDeck, dealPlayersHands, gameStart, getActionPlayer, getInfo, getState, getTableInfo, intervalTime, join, level, playersCount, shuffleArray, shufflePlayers, state, structure, tables;
