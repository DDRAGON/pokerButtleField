...
(function() {
  var Config, Controller, action, createWebSocketter, goToNextHand, makeSocket, makeSpectatorSocket, sendSpectatorData, spectatorCounter, spectatorSockets, waiting, webSockets;
  ...
  sendSpectatorData = function() {
    if (spectatorCounter > 0) {
      return spectatorSockets.emit('spectatorData', Controller.getTableInfo(0));
    }
  };
